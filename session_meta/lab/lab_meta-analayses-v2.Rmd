...
library(reticulate)
reticulate::use_condaenv('meta_env')
```
...
![](assets/Statistical_methods_MetaDE.png)
...
install.packages(c("xts", "quantmod", "zoo", "abind", "rpart", "class", "ROCR","proto", "foreach", "iterators", "combinat", "remotes", "plyr"))
...
install.packages("https://cran.r-project.org/src/contrib/Archive/MetaQC/MetaQC_0.1.13.tar.gz", repos = NULL, type = "source")
...
install.packages("https://cran.r-project.org/src/contrib/Archive/MetaPath/MetaPath_1.0.tar.gz", repos = NULL, type = "source")

# Install Bioconductor packages
if (!requireNamespace("BiocManager", quietly = TRUE)) install.packages("BiocManager")
BiocManager::install(c("AnnotationDbi", "genefilter", "GSEABase"))

# Install packages from GitHub
remotes::install_github("metaOmic/preproc")
remotes::install_github("metaOmics/MetaDCN")
```
