...
`r sn<-sn+1; paste0(sn,"\\. ")` If you have not done so already, activate the `envnets` conda environment
```{bash, eval=F}
...
`r sn<-sn+1; paste0(sn,"\\. ")` If your conda installation fails, navigate to the directory where "renv.lock" file is located and run following code chunk.
