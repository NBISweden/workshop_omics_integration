...
knitr::include_graphics('lab/assets/tcga_gdc_banner.png')
```
...
`r sn<-sn+1; paste0(sn,"\\. ")` Create a `TCGA_data/` subdirectory within `data/` (if it does not yet exist)
```{r}
...
```{r}
de.res <- read.delim("./lab/data/TCGA_data/DE_results.txt", row.names=1)
```
</br>
...
gsc <- piano::loadGSC("./lab/data/gene_set_collections/HumanGEM_subsystem_GSC.gmt")
...
gsc_fgsea <- fgsea::gmtPathways("./lab/data/gene_set_collections/HumanGEM_subsystem_GSC.gmt")
...
```{r}
counts <- read.table("./lab/data/TCGA_data/count_matrix.txt", row.names=1, header=T)
```
</br>
...
knitr::include_graphics('./lab/assets/MA_subystem_menu.png')
```
</br>
...
knitr::include_graphics('./lab/assets/MA_overlay_sidebar.png')
```
</br>
...
knitr::include_graphics('./lab/assets/MA_button_hide_subsys.png')
```
</br>
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics('./lab/assets/MA_button_fullscreen.png')
```
</br>
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics('./lab/assets/serotonin_pathway.svg')
```
</br>
...
knitr::include_graphics('./lab/assets/proline_interaction_partners.png')
```
</br>
...
knitr::include_graphics('./lab/assets/arginine_and_proline_metabolism.svg')
```
</br>
